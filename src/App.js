...
class App extends Component {
	...
	initCalendarState = () => ({
		...
		markings: [
			...
			{ type: 'one-date', date: '2019/01/05', label: 'one-date', className: [ 'one-date' ] },
			{ type: 'repetition-date', date: '05', label: 'repetition-date', className: [ 'repetition-date' ] },
			{ type: 'repetition-day', day: '1', label: 'repetition-day', className: [ 'repetition-day' ] },
			{
				type: 'period',
